...
def sourceRepository : String := "absolute-planes-metric-geometry-canonical-lane"
def sourceDescription : String := "Absolute Planes Metric Geometry"
...
def sourceTheoremStatement : TheoremStatement := {
  ...
  classicalBoundary := "classical absolute planes metric geometry boundary",
